 ...
 * @since 1.5
 */
class plgRestapiGroup_Announcement_Create extends JPlugin {
	
	function plgRestapiGroup_Announcement_Create( & $subject, $config ) {	
	...
	function onRestCall( $data ) {
		...
		$id = $this->createnewgroupannouncement( $data );
	...
	function createnewgroupannouncement( $data ) 
	{	
